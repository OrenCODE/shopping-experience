...
/* harmony import */ var ng_mat_search_bar__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ng-mat-search-bar */ "./node_modules/ng-mat-search-bar/fesm5/ng-mat-search-bar.js");
...
/* harmony import */ var countup_js_angular2__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! countup.js-angular2 */ "./node_modules/countup.js-angular2/fesm5/countup.js-angular2.js");
...
var AddModalComponent = /** @class */ (function () {
    ...
    AddModalComponent.prototype.save = function () {
        var _this = this;
        var newProductValues = this.addProductForm.getRawValue();
        var newProduct = {
...
var AdminPageComponent = /** @class */ (function () {
    function AdminPageComponent(authService, productService, categoryService, router, dialog) {
        this.authService = authService;
        this.productService = productService;
    ...
    AdminPageComponent.prototype.getAllProducts = function () {
        ...
        this.productService.getAllProducts().subscribe(function (data) {
            _this.products = data;
            _this.productsLength = data.length;
            console.log(_this.productsLength);
        });
    };
    ...
    AdminPageComponent.prototype.openEditDialog = function (productValues, categoriesObject) {
        var _this = this;
        var dialogRef = this.dialog.open(_edit_modal_edit_modal_component__WEBPACK_IMPORTED_MODULE_7__["EditModalComponent"], {
            data: {
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(authService, productService, cartService, orderService) {
        this.authService = authService;
        this.productService = productService;
    ...
    DashboardComponent.prototype.getUserAuthDetails = function () {
    ...
    DashboardComponent.prototype.getUserCartStatus = function () {
        var _this = this;
        this.cartService.getUserCartStatus(this.userId, this.userToken).subscribe(function (data) {
            // IF cart has been initialized
            if (data.status === 0) {
                _this.orderService.checkIfUserHasOrder(_this.userId, _this.userToken).subscribe(function (data) {
                    if (data[0]) {
                        _this.dashboardMessage = "Your Last Order From: " + (new _angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"]('en').transform(data[0].orderDate, 'dd/MM/yyyy'));
                        _this.messageStatus = 2;
                    }
                    else {
                        _this.dashboardMessage = 'Click Below To Start Your First FOODJAM Experience';
                        _this.messageStatus = 0;
                    }
                });
            ...
            if (data.status === 1) {
                _this.dashboardMessage = data.msg;
                _this.messageStatus = 1;
                _this.continueShopButton = true;
                _this.authService.storeCartData(data.cart);
                return;
                // IF the user is new
            }
    ...
    DashboardComponent.prototype.getAllProducts = function () {
        var _this = this;
        this.productService.getAllProducts().subscribe(function (data) {
    ...
    DashboardComponent.prototype.getAllOrders = function () {
        var _this = this;
        this.orderService.getOrdersLength().subscribe(function (data) {
            _this.numOfOrders = data;
        });
    };
    DashboardComponent.prototype.getAllCheapProducts = function () {
        var _this = this;
        this.productService.getCheapProductsLength().subscribe(function (data) {
            console.log(data);
            _this.numOfCheapProducts = data;
        });
    };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(authService, productService, orderService) {
        this.authService = authService;
        this.productService = productService;
        this.orderService = orderService;
        this.slides = [[]];
        this.chunk = function (arr, chunkSize) {
            var R = [];
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.productService.getAllProducts().subscribe(function (data) {
            _this.numOfProducts = data.length;
            _this.slides = _this.chunk(data, 3);
        });
        this.orderService.getOrdersLength().subscribe(function (data) {
            _this.numOfOrders = data;
        });
...
var InvoiceComponent = /** @class */ (function () {
    function InvoiceComponent(productService, router) {
        this.productService = productService;
        this.router = router;
        this.isLoading = true;
    ...
    InvoiceComponent.prototype.backToDashBoard = function () {
...
var OrderComponent = /** @class */ (function () {
    function OrderComponent(authService, productService, orderService, cartService, formBuilder, router) {
        var _this = this;
        this.authService = authService;
        this.productService = productService;
        this.orderService = orderService;
        ...
        this.myFilter = function (d) {
            var day = d.getDay();
            return (!_this.fullyBookedDates.includes(d.valueOf()));
        };
        this.dateClass = function (d) {
            var day = d.getDay();
            return (_this.fullyBookedDates.includes(d.valueOf())) ? 'occupied-date-class' : undefined;
        };
    }
    ...
    OrderComponent.prototype.onOrderSubmit = function () {
        ...
        var cardName = orderDetails.cardName;
        var creditCard = orderDetails.creditCard.toString();
        var cvv = orderDetails.cvv.toString();
        var deliveryDate = new _angular_common__WEBPACK_IMPORTED_MODULE_8__["DatePipe"]('en').transform(orderDetails.deliveryDate, 'yyyy/MM/dd');
        var products = this.authService.userCart.products;
        var order = {
            userId: this.userId,
            cartId: this.cartId,
    ...
    OrderComponent.prototype.getCartTotalPrice = function () {
        var _this = this;
        this.cartService.getUserCartStatus(this.userId, this.userToken).subscribe(function (data) {
            _this.totalPrice = data.cart.totalCartPrice;
        });
    };
    OrderComponent.prototype.convertArrToObject = function (productsArray) {
        var productsObj = {};
        for (var i = 0; i < productsArray.length; i++) {
            productsObj[productsArray[i]._id] = productsArray[i];
        }
    ...
    OrderComponent.prototype.getFullyBookedDates = function () {
        var _this = this;
        this.orderService.getFullyBookedDates(this.userToken).subscribe(function (data) {
            _this.fullyBookedDates = data.map(function (obj) { return new Date(obj.date).getTime(); });
        });
    };
    OrderComponent.prototype.capFirstLetter = function (string) {
        return string.charAt(0).toUpperCase() + string.slice(1);
    };
...
module.exports = "::ng-deep body {\n  overflow: no-display;\n}\n\n.nav-props {\n  background-color: #121348;\n  color: #fff;\n}\n\n.navbar-dark .navbar-toggler {\n  margin: 0 15px;\n}\n\n.active-btn {\n  color: bisque;\n  box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.16), 0 2px 10px 0 rgba(0, 0, 0, 0.12);\n  border: 0;\n}\n\n.search-results {\n  text-align: center;\n  margin: 10px;\n  font-weight: 600;\n}\n\n.expandable:target {\n  height: 50px;\n}\n\n.example-container {\n  min-height: 750px;\n  margin: auto;\n}\n\n.example-sidenav-content {\n  display: flex;\n  height: 100%;\n  align-items: center;\n  justify-content: center;\n}\n\n.example-sidenav {\n  width: 30%;\n  padding: 16px 8px 0 30px;\n}\n\n.p-card {\n  padding: 0;\n}\n\n.quantity-section {\n  margin-bottom: 2px;\n}\n\n.in-cart {\n  font-size: 13px;\n  color: #121348;\n  font-weight: bolder;\n  margin: auto;\n  text-align: center;\n}\n\n.card-footer {\n  padding: 0;\n}\n\n.row {\n  margin: auto;\n}\n\n.cart-item-img {\n  width: 100%;\n}\n\n.mat-card {\n  padding: 0;\n}\n\n.card-img-top {\n  width: 40%;\n}\n\n.productImg {\n  padding: 22px;\n}\n\n.cartImg {\n  padding: 5px;\n}\n\n.cartItem {\n  padding: 2px 0 10px 0;\n}\n\n.input-res {\n  background: #F7F7F7;\n  border: none;\n  text-align: center;\n  padding-left: 13px;\n  font-size: 18px;\n  font-weight: 500;\n  width: 100%;\n  height: 100%;\n  max-width: 500px;\n  box-sizing: border-box;\n}\n\n.input-box {\n  padding: 0;\n}\n\n.qnt-btn {\n  color: #121348;\n  border-radius: 0;\n  padding: 0;\n  min-width: 0;\n}\n\n.checkout-btn {\n  position: fixed;\n  bottom: 40px;\n  right: 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ShopComponent = /** @class */ (function () {
    function ShopComponent(authService, categoryService, productService, cartService) {
        this.authService = authService;
        this.categoryService = categoryService;
        this.productService = productService;
        this.cartService = cartService;
    ...
    ShopComponent.prototype.deleteProductFromCart = function (_id) {
        ...
        if (this.currentCartProducts.length === 1) {
            var status_1 = { isOpen: 0 };
            var cartId = this.cartId;
            this.updateCartStatus(cartId, status_1);
        }
    };
    ShopComponent.prototype.emptyCart = function () {
        var _this = this;
    ...
    ShopComponent.prototype.addItem = function (_id) {
        this.quantity += 1;
        this.sendToCart(_id, this.quantity);
    };
    ShopComponent.prototype.removeItem = function (_id) {
    ...
    ShopComponent.prototype.sendToCart = function (_id, quantity) {
        ...
        if (cartStatus === 0) {
            var status_2 = { isOpen: 1, date: new Date() };
            this.updateCartStatus(cartId, status_2);
        }
    ...
    ShopComponent.prototype.updateCartStatus = function (cartId, cartStatus) {
        var _this = this;
        this.cartService.updateCartStatus(cartId, cartStatus, this.userToken).subscribe(function (data) {
            _this.updateLocalStorage(data);
        });
    };
    ShopComponent.prototype.getAllProducts = function () {
        var _this = this;
        this.productService.getAllProducts().subscribe(function (data) {
            _this.convertArrToObject(data);
    ...
    ShopComponent.prototype.getUserCartStatus = function () {
        var _this = this;
        this.cartService.getUserCartStatus(this.userId, this.userToken).subscribe(function (data) {
    ...
    ShopComponent.prototype.updateCartTotalPrice = function () {
        var _this = this;
        var totalCartPrice = { totalCartPrice: this.totalPrice };
        this.cartService.setCartTotalPrice(this.cartId, totalCartPrice, this.userToken).subscribe(function (data) {
            _this.updateLocalStorage(data);
        });
    };
    ShopComponent.prototype.convertArrToObject = function (productsArray) {
        var productsObj = {};
        for (var i = 0; i < productsArray.length; i++) {
            productsObj[productsArray[i]._id] = productsArray[i];
        }
    ...
    ShopComponent.prototype.allowNumbersOnly = function (e) {
...
var SignupStepperComponent = /** @class */ (function () {
    function SignupStepperComponent(formBuilder, authService, router) {
        this.formBuilder = formBuilder;
        this.authService = authService;
        this.router = router;
        this.isLinear = false;
    ...
    SignupStepperComponent.prototype.ngOnInit = function () {
        // Disable route access if already loggedIn
        if (this.authService.isUserLoggedIn()) {
            this.router.navigate(['dashboard']);
        }
    ...
    SignupStepperComponent.prototype.onFirstStepSubmit = function (stepper) {
        var _this = this;
    ...
    SignupStepperComponent.prototype.onSecondStepSubmit = function () {
        var _this = this;
        ...
        this.authService.registerUser(user).subscribe(function (user) {
            ...
            if (user) {
                var loginDetails = { email: credentials.email, password: credentials.password };
            ...
            if (err.status === 400) {
                ...
                _this.userIsRegistered = false;
            }
        });
    };
    SignupStepperComponent.prototype.redirectToDashboard = function (loginDetails) {
        var _this = this;
        this.authService.loginUser(loginDetails).subscribe(function (data) {
            if (data.success) {
                _this.authService.storeUserData(data.token, data.user);
    ...
    // Change to Promise
    SignupStepperComponent.prototype.goForward = function (stepper) {
        var _this = this;
        setTimeout(function () {
    ...
    SignupStepperComponent.prototype.allowNumbersOnly = function (e) {
        var code = (e.which) ? e.which : e.keyCode;
        if (code > 31 && (code < 48 || code > 57)) {
            e.preventDefault();
        }
    };
    SignupStepperComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.updateCartStatus = function (cartId, cartStatus, token) {
...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.getOrdersLength = function () {
    ...
    OrderService.prototype.getFullyBookedDates = function (token) {
        return this.http.get('api/order/getFullyBookedDates', { headers: { Authorization: token } });
    };
    OrderService.prototype.checkIfUserHasOrder = function (userId, token) {
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.searchProducts = function (name) {
    ...
    ProductService.prototype.createNewProduct = function (newProduct, token) {
        return this.http.post('api/product/createNewProduct', newProduct, { headers: { Authorization: token } });
    };
    ProductService.prototype.getCheapProductsLength = function () {
